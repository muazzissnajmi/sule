        ...
        <div class="widget-content nopadding form-horizontal">            
            ...
            <div class="collapse in accordion-body" id="collapseGOne">
              ...
              <div class="controls">
                ...
                <input type="text" class="span11" name="" placeholder="Nomor Referensi" value="100.3.5/SPT/<?php echo $data['no_spt']; ?>/<?php echo substr($data['tgl_spd'],-4);?>" readonly />
              </div>
            </div>
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls"><textarea class="span11" name="keterangan"  rows="5" readonly><?php echo $data['keterangan_spd'];?></textarea></div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="control-group">
                  <input type="text" data-date="01-02-2013" name="tgl_berangkat" data-date-format="dd-mm-yyyy"value="<?php echo $data['tgl_berangkat'];?>" class="datepicker span3" readonly></div>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="tiba_di_2" disabled> 
                <option>...</option>
                <?php
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="tiba_di_3" disabled> 
                <option>...</option>
                <?php
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="control-group">
                  <input type="text" data-date="01-02-2013" name="tgl_kembali" data-date-format="dd-mm-yyyy" value="<?php echo $data['tgl_kembali'];?>" class="datepicker span3" readonly>
                </div>
              </div>
            </div>
