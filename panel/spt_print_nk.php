                  ...
                  ?>
                      <tr valign="top">
                        ...
                        <td width="" colspan="2" align="justify"><b><?php echo ucfirst($data_['nama']); ?></b><br>
                            <?php echo ucfirst($data_['jabatan']); ?>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                      ...
                      <tr valign="top">
                        ...
                        <td width="" colspan="2" align="justify">
                          ...
                          <b><?php echo ucfirst($data_['nama']); ?></b><br>
                            ...
                            <?php echo ucfirst($data_['jabatan']); ?><?php } ?>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <b><?php echo ucfirst($data_ttd['nama']); ?></b><br>
                      <?php echo ucfirst($data_ttd['pangkat']); ?><br>
                      <?php if ($data_ttd['nip'] < 999999999999) { echo ""; }
                      else{?>
