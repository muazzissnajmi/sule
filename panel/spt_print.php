        ...
        <div class="widget-content nopadding form-horizontal">           
            ...
            <center>
              <?php
                ...
                if ($jabatan_ck == 'Pj. BUPATI BIREUEN') {                
              ?>
              <table class="table1" border="0">
              <!--<thead>
                <tr>
                  <td><center><img src="../img/logo_bireuen.jpg" width="85px"></center></td>
                  <td colspan="6">
                    <center>
                      <strong>
                        <font size="3px">PEMERINTAH KABUPATEN BIREUEN</font><br>
                        <font size="6px">SEKRETARIAT DAERAH</font><br>
                        <font size="1px">Jalan Sultan Malikussaleh Cot Gapu Bireuen 24251<br>
              ...
              <tr>
                <td colspan="7"><br><br><br><br><br><br><br><br></td>
              </tr>
              <tbody>                
                  ...
                  <td colspan="7">
                    <center>
                      <strong>
                        <br>
                        <?php if ($data['no_spt'] == '') {?>
                         <font size="3px"><u>SURAT TUGAS <?php echo $nd_spt ?></U></font><br>
                        NOMOR : 100.3.5/ST/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/<?php echo substr($data['tgl_spt'],-4);?><br><br>
                        <?php }else{?>
                        <font size="3px"><u>SURAT TUGAS</U></font><br>
                        NOMOR : 100.3.5/ST/<?php echo $data['no_spt']; ?>/<?php echo substr($data['tgl_spt'],-4);?><br><br>
                      <?php }?>
                      </strong>
                    </center>
                  </td>
                ...
                <tr>
                  <td colspan="7" height="30px"><br><center><strong>MEMERINTAHKAN : </strong></center><br></td>
                </tr>
                <tr>
                      ...
                      //$nip2 = $data_['pengikut']; 
                      ?>
                  <td valign="top" rowspan="<?php echo $row_; ?>">Kepada</td>
                  <td class="span1"  valign="top" rowspan="<?php echo $row_; ?>">:</td>
                  <?php 
                  ...
                  ?>
                      <tr valign="top">
                        ...
                        <td width="" colspan="2" align="justify"><b><?php echo ucfirst($data_['nama']); ?></b><br>
                            Plt. <?php echo ucwords(strtolower($data_['jabatan'])); ?>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                ...
                <tr>
                  ...
                  <td colspan="5" align="justify">
                    ...
                    ?>
                    Selama <?php echo $data_ket['lama_perjalanan']; ?> (<?php echo terbilang($data_ket['lama_perjalanan']); ?>) Hari terhitung mulai tanggal <?php echo tgl_indo($data_ket['tgl_berangkat']); ?> sampai dengan <?php echo tgl_indo($data_ket['tgl_kembali']); ?> di <?php echo trim($data_ket['kota']);?>
                  <?php if ($data_ket['tiba_di_2'] == '...') {
                    echo ".";
                ...
                <tr>
                  <td colspan="7" align="justify"><br>Demikian Surat Tugas ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</td>
                </tr>
                <tr>
                  ...
                  <td colspan="2" class="span3">
                    <center><br>
                      Ditetapkan di Bireuen<br>
                      Pada Tanggal <?php echo tgl_indo($tgl_spt); ?><br><br>
                  <?php
                  ...
                  if ($data['ttd'] == '') { ?>    
                      <b>Plt. <?php echo ucfirst($data_ttd['jabatan']); ?></b>
                    </center>
                  </td>
                </tr>                
                <tr>
                ...
                <tr>
                  ...
                  <?php }else{ ?><b><?php echo ucfirst($data_ttd['jabatan']); ?></b><br>u.b<br>
                  <?php 
            ...
            <?php }elseif ($jabatan_ck == 'BUPATI BIREUEN') {                
              ?>
              <table class="table1" border="0">
              <!--<thead>
                <tr>
              ...
              <tbody>                
                ...
                <tr>
                  ...
                  ?>
                      <tr valign="top">
                        ...
                        <td align="right" height="40px">:<br>:</td>
                        <td width="" colspan="2" align="justify"><b><?php echo ucfirst($data_['nama']); ?></b><br>
                            <?php echo ucwords(strtolower($data_['jabatan'])); ?>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                ...
                <tr>
                  ...
                  if ($data['ttd'] == '') { ?>    
                      <b><?php echo ucfirst($data_ttd['jabatan']); ?></b>
                    </center>
                  </td>
                </tr>                
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <b><?php echo ucfirst($data_ttd['nama']); ?></b><br>
                      <?php echo ucfirst($data_ttd['pangkat']); ?>
                    </center>
                  </td>
                  <?php }else{ ?><b><?php echo ucfirst($data_ttd['jabatan']); ?></b><br>u.b<br>
                  <?php 
            ...
            <?php }elseif ($jabatan_ck == 'WAKIL BUPATI BIREUEN') {                
              ?>
              <table class="table1" border="0">
              <!--<thead>
                <tr>
                  ...
                  <td colspan="7">
                    <center>
                      <strong>
                        ...
                        <?php if ($data['no_spt'] == '') {?>
                         <font size="3px"><u>SURAT TUGAS</U></font><br>
                        NOMOR : Peg.800.1.11.1/ST/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/<?php echo substr($data['tgl_spt'],-4);?><br><br>
                        <?php }else{?>
                        <font size="3px"><u>SURAT TUGAS</U></font><br>
                        NOMOR : Peg.800.1.11.1/ST/<?php echo $data['no_spt']; ?>/<?php echo substr($data['tgl_spt'],-4);?><br><br>
                      <?php }?>
                      </strong>
                    </center>
                  </td>
               ...
               <tr>                  
                ...
                <tr>
                  ...
                  ?>
                      <tr valign="top">
                        ...
                        <?php if ($data_['pangkat'] == '') {?>
                          <td class="span1" height="50px">
                         <?php }else{ ?> 
                          <td class="span1" height="80px">
                         <?php }?> 
                          <?php if ($data_['pangkat'] == '') {?>
                         Nama<br>Jabatan
                        <?php }else{ ?>Nama<br>Pangkat<br>NIP<br>Jabatan<?php } ?></td>

                        <td align="right" height="40px">
                          <?php if ($data_['pangkat'] == '') {?>
                            :<br>:
                          <?php }else{ ?>:<br>:<br>:<br>:<?php } ?></td>
                        <td width="" colspan="2" align="justify">
                          <?php if ($data_['pangkat'] == '') {?>
                            <b><?php echo ucfirst($data_['nama']); ?></b><br>
                            <?php echo $data_['jabatan']; ?>
                          <?php }else{ ?>
                          <b><?php echo ucfirst($data_['nama']); ?></b><br>
                            <?php if ($data_['pangkat'] == '') { echo "-"; }else{ ?>
                            <?php echo ucfirst($data_['pangkat']); ?> (<?php echo ucfirst($data_['golongan']); ?>)<?php }?><br>
                            <?php if ($data_['nip'] < 999999999999) { echo "-"; }else{?>
                            <?php 
                            if($data_['nip']==1976051720060410033){
                                $data_['nip'] = 197605172006041003;
                            }
                            echo konversi_nip($data_['nip']); }?><br>
                            <?php echo ucwords(strtolower($data_['jabatan'])); ?><?php } ?>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
                ...
                <tr>
                  ...
                  <td colspan="2" class="span3">
                    <br>
                      Ditetapkan di Bireuen<br>
                      Pada Tanggal <?php echo tgl_indo($tgl_spt); ?><br><br><center>
                      <?php 
                      $sql_ttd = "SELECT * FROM ttd_pejabat INNER JOIN pegawai ON ttd_pejabat.nip_pejabat=pegawai.nip WHERE id_ttd_pejabat='$data[berwenang]'";
                      $tampil_ttd = mysqli_query($koneksi, $sql_ttd);     
                      $data_ttd = mysqli_fetch_array($tampil_ttd);
                      $jabatan_ttd = $data_ttd['jabatan'];
                      if ($jabatan_ttd == 'BUPATI BIREUEN') { echo "<b>Plt.</b> ";
                      }elseif ($jabatan_ttd == 'WAKIL BUPATI BIREUEN'){
                      
                      }else{ ?>a.n BUPATI BIREUEN<br> <?php }?>
                  <?php
                  if ($nd_spt != '') { ?>    
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <b><?php echo ucfirst($data_tt['nama']); ?></b><br>
                      <?php echo ucfirst($data_tt['pangkat']); ?><br>
                      <?php if ($data_tt['nip'] < 999999999999) { echo "-"; }else{?>
                            <?php echo "Nip. ". konversi_nip($data_tt['nip']); }?>
                    </center>
                  </td>
