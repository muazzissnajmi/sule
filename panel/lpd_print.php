        ...
        <div class="widget-content nopadding form-horizontal">           
            ...
            <table class="table1" border="0">
              ...
              <tr>
                ...
                <td></td>
                <?php 
                $sql_nama = "SELECT * FROM pengikut INNER JOIN pegawai ON pengikut.pengikut=pegawai.nip INNER JOIN kwitansi ON pegawai.nip=kwitansi.nip WHERE no_spt='$id_spt' ORDER BY golongan DESC";
                $tampil_nama = mysqli_query($koneksi, $sql_nama);  
                
                if($sql_nama['jabatan']=="Pj. BUPATI BIREUEN" || $sql_nama['jabatan']=="BUPATI BIREUEN" || $sql_nama['jabatan']=="WAKIL BUPATI BIREUEN"){
                            $nomorspt = "100.3.5";
                        }else{
              ...
              <tr>
                ...
                <td colspan="5"><?php echo ucfirst($data_['nama']); ?><br>                  
                 <?php if ($data_['nip'] < 999999999999) { echo ""; }else{?>
                            Nip. <?php echo konversi_nip($data_['nip']); }?><br></td>
