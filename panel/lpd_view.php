...
<div id="content-header">
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?page=lpd" class="tip-bottom">LPD</a> <a href="#" class="current">Data LPD</a></div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding form-horizontal">           
            ...
            <div class="control-group">
              ...
              <div class="controls">                
                <input type="text" class="span11" name="no_spt" id="no_spt" value="<?php echo $data_kota['kota']; ?>" placeholder="" readonly />
              </div>
            </div>  
            ...
            <div class="control-group">
              ...
              <div class="controls">                
                <input type="text" class="span11" name="no_spt" id="no_spt" value="<?php echo $data_spd['lama_perjalanan']; ?> (<?php echo terbilang($data_spd['lama_perjalanan']); ?>) Hari, Mulai Tanggal <?php echo tgl_indo($data_spd['tgl_berangkat']); ?> s/d <?php echo tgl_indo($data_spd['tgl_kembali']); ?>" placeholder="" disabled />
            ...
            <label class="control-label">Hasil Yang Dicapai :</label>
              <div class="controls"><textarea class="span11" name="hasil" rows="5" disabled=""><?php echo ucfirst($data_lpd['hasil_dicapai']); ?></textarea></div>
            </div>
