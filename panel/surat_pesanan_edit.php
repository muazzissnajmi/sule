...
<div id="content-header">
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?page=sups" class="tip-bottom">Amprahan</a> <a href="#" class="current">Edit Amprahan</a></div>
  
</div>
<div class="container-fluid">
<h3>Edit Amprahan</h3>

<form class="form-horizontal" method="post" action="?page=supes" name="" enctype="multipart/form-data">
...
<div class="control-group">
    <label class="control-label">Nomor Amprahan</label>
        ...
        <div class="controls">
                <input type="hidden" class="span1" name="kode_amprahan" value="<?= $h['kode_amprahan'] ?>" />
                <input type="text" class="span1" name="kode_item"  placeholder="" value="<?= $h['kode_item'] ?>"/> / 
                <input type="text" class="span2" name="no_amprahan"  placeholder="" value="<?= $h['no_amprahan'] ?>" /> /  
...
<div class="control-group">
              ...
              <div class="controls">
                <div class="control-group">
                  <input type="text" data-date="01-02-2013" name="tgl_pesanan" data-date-format="dd-mm-yyyy" value="<?= date('d-m-Y', strtotime($h['tanggal'])); ?>" class="datepicker span4">
...
<div class="control-group">
    ...
    <div class="controls">
        <select name="tujuan" class="span6 select2">
...
<div class="control-group">
    ...
    <div class="controls">
        <select name="pejabat_berwenang" class="span6 select2">
        ...
        <div id="div">
            <?php while ($d = mysqli_fetch_array($qD)) : ?>
                <p id="row<?= $d['id_detail'] ?>" class="item-row">
                    ...
                    <input type="number" 
                           name="banyak_edit[<?= $d['id_detail'] ?>]" 
                           value="<?= $d['banyak'] ?>" 
                           class="span1">
            
                    <label style="margin-left:15px;margin-right:5px;">Satuan:</label>
                    <input type="text" 
                           name="satuan_edit[<?= $d['id_detail'] ?>]" 
                           value="<?= $d['satuan'] ?>" 
                           class="span1">
            
                    <label style="margin-left:15px;margin-right:5px;">Ket:</label>
                    <input type="text" 
                           name="ket_edit[<?= $d['id_detail'] ?>]" 
                           value="<?= $d['keterangan'] ?>" 
                           class="span2">
            
                    <a href="#" onclick='hapusElemen("#row<?= $d['id_detail'] ?>"); return false;'>
...
function tambah() {
    ...
    $('#div').append(`
        <p id="new${idf}" class="item-row">
            ...
            <label style="margin-left:15px;margin-right:5px;">Satuan:</label>
            <input type="text" name="satuan_new[]" class="span1">

            <label style="margin-left:15px;margin-right:5px;">Ket:</label>
            <input type="text" name="ket_new[]" class="span2">
