...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <a href="?page=supst" class="btn btn-success btn-mini"><span class="icon-plus"></span> &nbsp; Surat Pesanan</a>
    
    <!-- Tombol -->
<a href="#" class="btn btn-danger btn-mini" id="btnFaktur">
  <span class="icon-plus"></span> &nbsp; Faktur
</a>

<!-- Popup Pilih Tanggal -->
<div id="popupTanggal" style="display:none; padding:10px;">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM pesanan_barang_kode ORDER BY kode_pesanan_barang DESC";
