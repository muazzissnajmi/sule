  ...
  <div class="row-fluid">
    <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal" action="?page=spd" name="" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
               ...
               <select name="id_spt" required>    
                  <option value="">...</option>                
                  <?php
                    $sql = "SELECT * FROM spt WHERE cek_spt='Y'";
                    $tampil = mysqli_query($koneksi, $sql);     
                    while ($data = mysqli_fetch_array($tampil)) {
                      
                  ?> 
                    <option value="<?php echo $data['id_spt']; ?>"><?php echo ucfirst($data['id_spt']); ?> (800/SPT/<?php echo ucfirst($data['no_spt']); ?>/<?php echo date("Y"); ?>)</option>
                  <?php  } ?>
                </select>
            ...
            <div class="row-fluid">
              ...
              <center>
                ...
                <a href="?page=sppd" type="reset" class="btn btn-danger">Cancel</a>
              </center>
              </div>
            </div>
          </form>
