...
<div id="content-header">
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?page=upfspt" class="tip-bottom">Upload Perjalanan</a> <a href="#" class="current">Pilih SPT</a></div>
  ...
  <div class="row-fluid">
    <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method="post" class="form-horizontal" action="?page=upft" name="" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <?php if($type=='Administrator'){ ?>
                ...
                <select name="id_spt" required>    
                  ...
                  ?> 
                    <option value="<?php echo $data['id_spt']; ?>"><?php echo ucfirst($data['id_spt']); ?> (800/SPT/<?php echo ucfirst($data['no_spt']); ?>/2019)</option>
                  <?php  } ?>
                </select>
              ...
              <?php } if($type=='MembersView1'){ ?>
                ...
                $sql_pengikut = "SELECT * FROM pengikut WHERE pengikut = '$data_user[nip]'";
                ...
                <select name="id_spt" required>    
                  ...
                  <?php                     
                    ...
                    $sql = "SELECT * FROM spt WHERE id_spt = '$data_pengikut[no_spt]'";
                    $tampil = mysqli_query($koneksi, $sql);     
                    while ($data = mysqli_fetch_array($tampil)) {
