...
if ($tgl_awal1 == '11-2019') {
  echo '01-11-2019';
}else{}

if ($tgl_akhir2 == '11-2019') {
  echo '31-11-2019';
}else{}
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="control-group">
                  ...
                  ?>    
                <option value="<?php echo $data['nip']; ?>" <?php if ($data['nip'] == $asn) { echo "selected"; } ?>><?php echo ucfirst($data['nama']); ?></option>
              <?php  } ?>
                </select>&nbsp;&nbsp;&nbsp;
                  <input type="text" data-date="01-02-2013" name="tgl_awal" data-date-format="dd-mm-yyyy" value="<?php echo $tgl_awal; ?>" class="datepicker span2">&nbsp;&nbsp;&nbsp;s/d&nbsp;&nbsp;&nbsp;
                  <input type="text" data-date="01-02-2013" name="tgl_akhir" data-date-format="dd-mm-yyyy" value="<?php echo $tgl_akhir; ?>" class="datepicker span2">&nbsp;&nbsp;&nbsp;
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <?php
                  ...
                  //$sql = "SELECT * FROM pengikut INNER JOIN spt ON pengikut.no_spt=spt.id_spt INNER JOIN spd ON spt.id_spt=spd.id_spt WHERE pengikut LIKE '$asn' AND tgl_berangkat = '$tgl_awal'";

                  $tgl_awal5 = "01-".$tgl_awal1;
                  $tgl_akhir5 = "31-".$tgl_akhir2;

                  $sql = "SELECT * FROM pengikut INNER JOIN spt ON pengikut.no_spt=spt.id_spt INNER JOIN spd ON spt.id_spt=spd.id_spt WHERE pengikut LIKE '$asn' AND tgl_berangkat BETWEEN '$tgl_awal' AND '$tgl_akhir'";

                  //$sql = "SELECT * FROM lpd INNER JOIN spt ON lpd.id_spt=spt.id_spt INNER JOIN spd ON spt.id_spt=spd.id_spt INNER JOIN pengikut ON spt.id_spt=pengikut.no_spt WHERE pengikut LIKE %$asn% AND tgl_berangkat BETWEEN '$tgl_awal' AND '$tgl_akhir'";
                  $tampil = mysqli_query($koneksi, $sql);
