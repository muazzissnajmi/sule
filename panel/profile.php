...
$sql_ = "SELECT * FROM users INNER JOIN pegawai ON users.nip=pegawai.nip WHERE username = '$username' ORDER BY username ASC";
...
$sql = "SELECT * FROM pegawai WHERE nip = '$nip_'";
...
<div id="content-header">
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Home</a> <a href="?page=pegawai" class="tip-bottom">My Profile</a></div>
    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Data Diri <?php echo ucfirst($jk.". ".$data['nama']); ?></h5>
        </div>
          <?php
        ...
        <div class="widget-content nopadding form-horizontal">            
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="nama" placeholder="Nama" value="<?php echo $data['pangkat']; ?> (<?php echo $data['golongan']; ?>)" disabled />
              </div>
            </div> 
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Format Tanggal (Hari-Bulan-Tahun)</span> <br><br></div>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Username" value="<?php echo $username; ?>" disabled />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Email :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Email" value="<?php echo $email_; ?>" disabled />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Hak Akses :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Hak Akses" value="<?php echo $rule_; ?>" disabled /><br><br>
              </div>
            </div>
        </div>
      </div>
