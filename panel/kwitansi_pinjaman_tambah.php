...
<h3>Kwitansi Pinjaman</h3> 

<?php
$msg = isset($_GET['msg']) ? $_GET['msg'] : null;            
  if ($msg == 1) { ?>
  <div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
  <h4 class="alert-heading">Success!</h4>Data Kwitansi Pinjaman Berhasil Disimpan!</div>
  <?php } else if ($msg == 2) {?>
  <div class="alert alert-error alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
  <h4 class="alert-heading">Error!</h4>
  Gagal Menyimpan Data Kwitansi Pinjaman!</div>       
<?php } ?>
...
?>
<form class="form-horizontal" method="post" action="?page=kws_pinjaman" name="" enctype="multipart/form-data">

<div class="row-fluid">
<div class="widget-box collapsible">
          <div class="widget-title"> <a href="#collapseOne" data-toggle="collapse"> <span class="icon"><i class="icon-align-justify"></i></span>
            <h5>Kwitansi Pinjaman</h5>
            </a> </div>
...
while ($data = mysqli_fetch_array($tampil)){
    ...
    <div class="widget-box collapsible">
      ...
      <div class="collapse in" id="<?php echo $nip ?>">
        <div class="widget-content">
          ...
          <div class="control-group">
            <div class="controls">
              <button type="button" class="btn btn-info"
                ...
                <span class="icon-plus"></span> Rincian Kwitansi Pinjaman
              </button>
            </div>
          </div>
        </div>
