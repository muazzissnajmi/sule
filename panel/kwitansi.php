...
<div id="content">
  ...
  <div class="container-fluid">
    <h3>KWITANSI</h3>
    <right><a href="?page=kwp" class="btn btn-success btn-mini"><span class="icon-plus"></span> Tambah Kwitansi</a></right>
    <div class="row-fluid">
            ...
            <table class="table table-bordered data-table table-responsive">
              ...
              <tbody>
                <?php
                  ...
                  $sql_kw = "SELECT * FROM kwitansi where tgl_kw like '%2025%' or tgl_kw like '%2026%' GROUP BY id_spt";
