...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">ASN</a></div>
  
</div>
  <div class="container-fluid">
    <h3>DATA ASN</h3>
    <right><a href="?page=pt" class="btn btn-success btn-mini"><span class="icon-plus"></span> Tambah ASN</a></right>
    <div class="row-fluid">
      ...
      <?php
            ...
            if ($msg == 1) { ?>
              ...
              <h4 class="alert-heading">Success!</h4>Data ASN Berhasil Dihapus!</div>
            <?php } else if ($msg == 2) {?>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr>
                  <td class="span3">
                    <?php if ($data['nip'] < 999999999999) { echo "<center>-</center>"; }else{?>
                    <center><a href="?page=pv&id=<?php echo $data['nip']; ?>"><span class="badge badge-info"><?php echo konversi_nip($data['nip']); ?></span></a></center>
                  <?php } ?>
                  </td>
                  <td class="span3"><strong><?php echo ucfirst($data['nama']); ?></strong></td>
