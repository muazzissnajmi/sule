...
<div id="content-header">
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?page=amp" class="tip-bottom">Surat Pesanan</a> <a href="#" class="current">Tambah Surat Pesanan</a></div>
  ...
  <div class="row-fluid">
    <div class="span12">
      <div class="widget-box">
        ...
        <form class="form-horizontal" method="post" action="?page=ampsim" name="" enctype="multipart/form-data">
        <?php
        ...
        <div class="widget-content nopadding form-horizontal">           
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="number" class="span1" name="kode_item"  placeholder="" /> / 
                <input type="number" class="span2" name="no_pesanan"  placeholder="" /> /  
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="tujuan" class="span5" required>
                    <option value="0" selected disabled hidden>-- Pilih Rekanan --</option>
                  <?php
                    include "../koneksi/koneksi.php";
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="program" id="program" class="span row-fluid" required>
                    <option value="0" selected disabled hidden>-- Pilih Program --</option>
                  <?php
                    include "../koneksi/koneksi.php";
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="kegiatan" id="kegiatan" class="span row-fluid" required>
                    <option value="0" selected disabled hidden>-- Pilih Kegiatan --</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="sub_kegiatan" id="sub_kegiatan" class="span row-fluid" required>
                    <option value="0" selected disabled hidden>-- Pilih Sub Kegiatan --</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="rekening" id="rekening" class="span row-fluid" required>
                  <option value="0" selected disabled hidden>-- Pilih Rekening Belanja--</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="uraian" id="uraian" class="span row-fluid" required>
                  <option value="0" selected disabled hidden>-- Pilih Uraian Belanja--</option>
            ...
            <div class="row-fluid">
             <div class="form-actions">
              <center>
                        ...
                        <a href="?page=amp" class="btn btn-danger">Cancel</a>
                        </center>
              </div>
            </div>
        </div>
...
function tambah() {
  ...
  const tahun = "<?= date('Y') ?>";
  const optionsItem = `<?= addslashes($options_item) ?>`;
  const optionsUraian = `<?= addslashes($options_uraian) ?>`;
  ...
  const stre = `
    <p id='srow${idf}'>
      ...
      <select name='satuan[]' class='span2'>${optionsItem}</select><br>
      <label>Uraian Barang/Jasa :</label>
      <select name='uraian[]' class='span5'>${optionsUraian}</select>
