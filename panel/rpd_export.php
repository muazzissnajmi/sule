...
?>
          ...
          <?php } ?>
            ...
            <table  border="1">
                ...
                <tr>
                  <th rowspan="2" style="vertical-align: middle;" width="10px">No.</th>
                  <th rowspan="2" style="vertical-align: middle;" width="250px">Nama</th>
                  <th rowspan="2" style="vertical-align: middle;" width="250px">Jabatan</th>
                  <th rowspan="2" style="vertical-align: middle;" width="250px">Tujuan</th>
                  <th rowspan="2" style="vertical-align: middle;" width="60px">No SPT</th>
                  <th colspan="2">Tanggal</th>
                  <th rowspan="2" style="vertical-align: middle;" width="70px">Jumlah Hari</th>
                  <th rowspan="2" style="vertical-align: middle;" width="150px">Anggaran</th>
                  <th rowspan="2" style="vertical-align: middle;" width="150px">Keterangan</th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <td><?php echo $sql_spt['keterangan']; ?></td>
                  <?php $total+=$jumlah; ?>
                </tr>
                <?php
                  }}
