...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="?page=home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Daftar Amprahan Gaji</a></div>
  
</div>
  <div class="container-fluid">
    <h3>Daftar Amprahan Gaji</h3>
    <a href="?page=supsgt" class="btn btn-success btn-mini"><span class="icon-plus"></span> &nbsp; Input Amprahan Gaji</a>
      ...
      <?php
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Data Table Amprahan Gaji</h5>
            ...
            <table class="table table-bordered data-table" id="tablePesanan">
              ...
              <tbody>
                <?php
                  ...
                  $sql = "SELECT * FROM amprahan_gaji ORDER BY id_amprahan DESC";
                ...
                <tr>
                  <td class="span2"><center>
                    ...
                    echo $data['kode_item']."/".$data['no_amprahan']."/".$data['tahun']; }?> </center></td>
